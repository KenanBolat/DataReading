...
add_data = "INSERT INTO sinop_observation (StationID, Latitude, Longitude, Altitude, Year, Month, Day, Hour, Minute, SnowDepth) " \
...
# Define Path
data_path = r"I:\temp\DailyGroundObservations\DailyGroundObservations\sinoptik"
merged_file = []
b = []
